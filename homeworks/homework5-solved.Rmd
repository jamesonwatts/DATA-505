...
**Answer:** Because we are actually modeling a continuous variable (probability of class membership). This probability can then be used to determine class membership.
