...
1. Use the Caret library to partition the wino dataframe. 
2. Then run a linear regression with bootstrap resampling. 
3. Report RMSE when your model is run on the testing data
